  ...
  return (
    <div className="flex flex-col text-center justify-center">
     ...
     <div className="flex flex-row justify-center my-5 text-4xl">
       <button
         className={`mr-10 ${selectedOption === "CREATIVO" ? "bg-white bg-opacity-40 rounded-full" : ""}`}
         onClick={() => handleOptionClick("CREATIVO")}
       >
        CREATIVO
       </button>
       <button
         className={`ml-10 ${selectedOption === "RACIONAL" ? "bg-white bg-opacity-40 rounded-full" : ""}`}
